        ...
        <div class="row">
            ...
            <div class="col-lg-12 py-5 col-md-12 col-12">
                <table class="table table-bordered table-responsive schedule-table">
                    ...
                    for($tijd = 1230; $tijd <=2200; $tijd = $tijd+200) {
                        $tijd2 = $tijd - 100;
                        $tijd3 = $tijd - 150;
                        $tijd4 = $tijd - 50;

                        $querycount = $pdo->prepare("SELECT datum_activiteit, COUNT(datum_activiteit) FROM activiteiten GROUP BY datum_activiteit HAVING COUNT(datum_activiteit) > 1");

...
<table border="black 1px" align="center" cellpadding="5px">
  ...
  <tr>
    ...
    echo "<tr>";
    for ($i = 1; $i <= 7; $i++) {
      $sql = 'SELECT * FROM reservatie_baan WHERE baan_nummer=' . $i . ' AND tijd_Begin="2000" AND datum="2021-11-16" ';
      echo $sql . "<br>";

      $result = $conn->query($sql);
      $rows = mysqli_num_rows($result);
      if ($rows) {
        echo "<td colspan='2'>bezet</td>";
      } else {
        echo "<td colspan='2'>beschikbaar</td>";
      }
    }
